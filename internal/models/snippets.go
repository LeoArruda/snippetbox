...
import (
	"database/sql"
	"errors" // New import for error handling
	"fmt"
	"time"
)
...
func (m *SnippetModel) Insert(title string, content string, expires int) (int, error) {
	...
	expireS := "+" + fmt.Sprintf("%d", expires) + " days"
	...
	stmt := `INSERT INTO snippets (title, content, created, expires) VALUES(?, ?, current_timestamp, DATE(current_timestamp, ?))`
...
func (m *SnippetModel) Get(id int) (Snippet, error) {
	...
	// If everything went OK, return the Snippet struct.
	return s, nil
